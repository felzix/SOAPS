...
public class SOAPSContentProvider extends ContentProvider {
	...
	public static final String CONTENT_PATIENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/patients";
	public static final String CONTENT_PATIENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/patient";
	public static final String CONTENT_FORM_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/forms";
	public static final String CONTENT_FORM_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/form";
    ...
    private int deletePatient(int uriType, Uri uri, String selection, String[] selectionArgs) {
    ...
    private int deleteForm(int uriType, Uri uri, String selection, String[] selectionArgs) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
    	...
    	if (uriType == PATIENTS || uriType == PATIENT_ID) {
    		return queryPatients(uriType, uri, projection, selection, selectionArgs, sortOrder);
    	} else if (uriType == FORMS || uriType == FORM_ID) {
    		return queryForms(uriType, uri, projection, selection, selectionArgs, sortOrder);
    	} else {
    		throw new IllegalArgumentException("Unknown URI: " + uri);
    	}
    }
    ...
    private Cursor queryPatients(int uriType, Uri uri, String[] projection,
        ...
        if (uriType == PATIENT_ID) {
        	...
        	queryBuilder.appendWhere(
        		PatientsTable.COLUMN_ID + "=" + uri.getLastPathSegment());
        }
    ...
    private Cursor queryForms(int uriType, Uri uri, String[] projection,
        ...
        if (uriType == FORM_ID) {
        	// Adding the ID to the original query
        	queryBuilder.appendWhere(
        		FormsTable.COLUMN_ID + "=" + uri.getLastPathSegment());
        }
